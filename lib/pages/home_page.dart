...
import 'package:law_hackathon_flutter/pages/mailing_list_page.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Future<void> _loadData() async {
    try {
      ...
      final authProvider = Provider.of<AuthProvider>(context, listen: false);
      _processMessages(authProvider.allMessages);
  ...
  void _openMailingListPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MailingListPage()),
    );
  }
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: _openMailingListPage,
